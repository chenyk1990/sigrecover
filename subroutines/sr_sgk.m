function [D,G]=sr_sgk(X,param)
%sr_sgk: SGK algorithm
% BY Yangkang Chen
% Jan, 2020
%
% INPUT
...
if K==1
    ...
    for i2=1:n2
        G(:,i2)=sr_omp0(D,X(:,i2),K);
    end
end
return

function [ g ] = omp_e( D, x )
% sr_omp0: Most basic orthogonal matching pursuit for sparse coding
