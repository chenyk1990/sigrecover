...
subplot(4,3,1);imagesc(x,t,d);colormap(seis);caxis([-0.01,0.01]);title('Raw');ylabel('Time (s)','Fontsize',10,'fontweight','bold');set(gca,'Linewidth',2,'Fontsize',10,'Fontweight','bold');text(-220,-8.5,'(a)','color','k','Fontsize',20,'fontweight','bold');
subplot(4,3,2);imagesc(x,t,d3);colormap(seis);caxis([-0.01,0.01]);title("Wang's");set(gca,'Linewidth',2,'Fontsize',10,'Fontweight','bold');text(-220,-8.5,'(b)','color','k','Fontsize',20,'fontweight','bold');
subplot(4,3,3);imagesc(x,t,d4);colormap(seis);caxis([-0.01,0.01]);title('New');set(gca,'Linewidth',2,'Fontsize',10,'Fontweight','bold');text(-220,-8.5,'(c)','color','k','Fontsize',20,'fontweight','bold');
subplot(4,3,4);imagesc(x,t,d33);colormap(seis);caxis([-0.01,0.01]);title('Retrieved signal');xlabel('Channel','Fontsize',10,'fontweight','bold');ylabel('Time (s)','Fontsize',10,'fontweight','bold');set(gca,'Linewidth',2,'Fontsize',10,'Fontweight','bold');text(-220,-8.5,'(d)','color','k','Fontsize',20,'fontweight','bold');
subplot(4,3,5);imagesc(x,t,d-d3);colormap(seis);caxis([-0.01,0.01]);title("Wang's Noise");xlabel('Channel','Fontsize',10,'fontweight','bold');set(gca,'Linewidth',2,'Fontsize',10,'Fontweight','bold');text(-220,-8.5,'(e)','color','k','Fontsize',20,'fontweight','bold');
subplot(4,3,6);imagesc(x,t,d-d4);colormap(seis);caxis([-0.01,0.01]);title('New noise');xlabel('Channel','Fontsize',10,'fontweight','bold');set(gca,'Linewidth',2,'Fontsize',10,'Fontweight','bold');text(-220,-8.5,'(f)','color','k','Fontsize',20,'fontweight','bold');
